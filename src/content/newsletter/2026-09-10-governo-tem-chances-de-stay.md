...
1. ***Notice of appeal*** (o *Doc 98*) — apenas avisa que vai recorrer, **sem argumentos**;
2. **Briefing** — governo apresenta razões, autores respondem, governo replica (**meses**);
3. **Sustentação oral** perante painel de 3 juízes;
4. **Decisão** — normalmente **muitos meses a mais de um ano** depois.
